...
export default function OWnerReg(){
    const init={
      ...
      .then(obj=>{
          ...
          fetch("http://localhost:8080/uploadImg/"+obj.own_id,reqOptions1)
          .then(resp=>resp.json())
          .then(obj=>{
            if(obj)
            {
    ...
    return(
      <div class="bg-img-own">
      <div className="Auth-form-container">
     
      <form className="Auth-form">
    <div className="Auth-form-content">
    <h3 className="Auth-form-title">Owner Registration</h3> 
    ...
    <div className="form-group mt-3">
      <input type="number" className="form-control mt-1"placeholder="Government Id no" id="govn_id_no" name="govn_id_no" value={info.govn_id_no} 
      onChange={(e)=>{dispatch({type:'update',fld:'govn_id_no',val:e.target.value})}}/>
    </div>
    <div className="form-group mt-3">
      <input type="file" className="form-control mt-1"placeholder="Government Id Image"id="govn_id_img" name="govn_id_img" 
